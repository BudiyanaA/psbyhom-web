				...
				<div class="col-sm-6">
					<div class="left-part alignleft">
						...
						@if(session()->has('user_id'))
							...
							<span><a href="{{ route('ewallet') }}"><?php echo number_format(getUserEwallet()); ?></a><input type="hidden" value='{{ getUserEwallet() }}' name='customer_ewallet' id='customer_ewallet'></span>
							</li>
