  ...
  <div style="color:#808080;font-family:Arial;font-size:14px;line-height:150%;text-align:left" align="left">
    ...
    <div style="text-align:left"></span>
      ...
      <a href="" style="color:#081071;font-weight:normal;text-decoration:none" target="_blank">
        <strong>House of Makeup</strong>
      </a>
    <div style="color:#808080;font-family:Arial;font-size:14px;line-height:150%;text-align:left" align="left">
      <div style="color:inherit;font-family:Arial;font-size:14px;line-height:150%;text-align:left;text-decoration:none" align="left">
        <!-- Line@ : <a href="https://line.me/R/ti/p/{{ $line_id }}">{{ $line_id }}</a> -->
        Instagram : <a href="https://www.instagram.com/houseofmakeup/">@houseofmakeup</a><br>
...
<table border="0" cellpadding="0" cellspacing="0" width="1000" style="background:#ffffff;border-top-width:0" bgcolor="#FFFFFF">
<tbody><tr>
<td valign="top" style="border-collapse:collapse">

<table border="0" cellpadding="0" cellspacing="0" width="1000" align='center' >
<tbody><tr>
<td width="23px" style="border-collapse:collapse;text-align:center"></td>
...
<tr><td><table border="0" cellpadding="10" cellspacing="0" width="1000" style="border-collapse:collapse">
<tbody><tr>
<td valign="top" style="border-collapse:collapse">
