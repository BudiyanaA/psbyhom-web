    ...
    <div class="col-xs-12">
		<div class="panel panel-midnightblue">
			<div class="panel-heading">
				{!! Form::model($po, ['route' => ['po_sginvoice.update', $po->POUUID], 'class' => 'form-horizontal', 'method' => 'PUT' ]) !!}
				  <h4>
										...
										<div class="col-sm-6 col-sm-offset-3">
											...
											@endif
												   ...
												   <!--  <button class="btn-primary btn" value ='update_status_barang' id="update_status_barang" name='tombol' type='button' > Go to Waiting Goodies</button>-->
													...
													< value ='delete' name='submit' onclick="javascript:$('#validate-form').parsley( 'validate' );">Delete</button>-->
											</div>
										</div>
									</div>
								</div>
