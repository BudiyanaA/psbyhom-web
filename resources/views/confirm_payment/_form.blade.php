<div class="row">
<div class="form-group 	@if ($errors->has('invoice')) has-error @endif col-md-6 col-lg-12">
		<label for="email2">Invoice *</label>
		{{ Form::number('invoice', null, ['class' => 'form-control', 'placeholder' => 'Invoice']) }}
		@if ($errors->has('invoice')) <small class="form-text help-block" style="color:red">{{ $errors->first('invoice') }}</small> @endif
	</div>
