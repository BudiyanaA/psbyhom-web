    ...
    <div id='wrap'>
        <div id="page-heading">
            ...
            <li><a href="{{ route('dashboard') }}">Dashboard</a></li>
                <li><a href="{{ route('voucher_management.index') }}">Voucher Management</a></li>
                <li class="active">Create New Voucher</li>
            </ul>
            ...
            <div class="panel-heading">
			 <h4>
					<ul class="nav nav-tabs">
					  <li class="active"><a href="#threads" data-toggle="tab"><i class="fa fa-list visible-xs icon-scale"></i><span class="hidden-xs">Tambah Voucher</span></a></li>
