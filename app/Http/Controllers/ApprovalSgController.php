...
class ApprovalSgController extends Controller
{
    public function index()
    {
        
        return view('approval_sg.index');
    }
    ...
    function newid()
        ...
        public function update(Request $request, $id)
        {
            ...
            try {
                if ($request->submit == "send_invoice") {
                    ...
                    $email_content = str_replace('https://psbyhom.com/view_request/$po_id', url('request/view/sg/' . $po_id), $email_content);
        ...
        public function show(Request $request, $id)
        {
            ...
            return view('approval_sg.detail', $data);
        }
    

    public function notification()
    {
        return view('approval_sg.notification');
    }
}
