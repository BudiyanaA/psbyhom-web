...
class ProcesOrderSgController extends Controller
{
    ...
    try {
        ...
        DB::commit();
        return redirect(route('process_order_sg.notification'))
...
public function edit($id)
    {
        ...
        // return $data['ewallet'];
        return view('processorder_sg.index', $data);
    }

    public function notification()
    {
        return view('processorder_sg.notification');
    }
